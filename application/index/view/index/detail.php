        ...
        <div class="detail-goods">
            <div class="detail-show">
                <div class="origin-show">
                    ...
                    <img class="big-pic" src="{$good['list_image']}" alt="{$good['name']}"/>
                </div>
                <div class="thumb-show">
                    {foreach $good['content_images'] as $pic}
                    <span class="item"><img class="s-pic" src="/{$pic}" bsrc="/{$pic}"/></span>
                    {/foreach}
                </div>
                <div class="zoom-show">
                    <img src="" alt=""/>
            ...
            <div class="detail-info">
                ...
                <div class="item-price">
                    <span class="now">￥<span name="price">{$good.unitprice}</span></span><span
                    ...
                    <div class="prop">
                        ...
                        <div class="dd">
                            <ul class="chose-img">
                                ...
                                <div class="attribute" name="attribute" number="{$gl.inventory}" price="{$good.unitprice}"
                                     gtid="{$gl.id}" style="display: inline;">
                                    {$gl.attr}
                                </div>
                                {/foreach}
                                <script>
    ...
    <div class="detail-bottom clearfix">
        ...
        <div class="detail-aside">
            <div class="detail-aside-box">
                ...
                <ul class="detail-hot">
                    {foreach $commendgoods as $cg}
                    <li>
                        <a href="/index/index/detail?id={$cg.id}" class="figure"><img src="/{$cg.list_image}" alt=""/></a>
                        <div class="name"><a href="/index/index/detail?id={$cg.id}">{$cg.name}</a></div>
                        <div class="price">
                            <span class="now">¥{$cg.unitprice}</span><span class="origin" style="text-decoration: line-through;">¥<?php echo sprintf('%.2f',$cg['unitprice'] + rand(0,300)) ?></span>
                        </div>
                    </li>
                    {/foreach}
                </ul>
