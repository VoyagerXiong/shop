                ...
                <div class="layui-colla-content layui-show">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" value="{$oldData['name']}" class="layui-input">
                        </div>
                    </div>
                            ...
                            <select name="category_id">
                                ...
                                <?php if (is_array($categorydata)): ?>
                                    <?php foreach ($categorydata as $column): ?>
                                        <option value="{$column['id']}" <?php if ($column['id'] == $oldData['category_id']): ?>selected<?php endif; ?>>{$column['name']}</option>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </select>
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="price" value="{$oldData['unitprice']}" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="date" name="uptime" value="{$oldData['uptime']}" class="layui-input">
                        </div>
                    </div>
                        ...
                        <div class="layui-input-block">
                            <div class="layui-upload">
                                ...
                                <div class="layui-upload-list">
                                    <img src="/{$oldData['list_image']}" class="layui-upload-img" id="showimage"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="number" name="click" value="{$oldData['click']}" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-upload">
                                <script id="container" name="content" type="text/plain">{$oldData['content']}</script>
