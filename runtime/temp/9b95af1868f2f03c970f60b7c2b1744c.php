<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/shop.vohome.xin/public/../application/admin/view/order/index.php";i:1512822828;s:70:"/www/wwwroot/shop.vohome.xin/public/../application/admin/view/base.php";i:1512722593;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
        ...
        <table class="layui-table" lay-even="" lay-skin="row">
            ...
            <?php if (is_array($orders)): foreach ($orders as $order): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/order/<?php echo $order['id']; ?>"><?php echo $order['ordernum']; ?></a>
                        </td>
                        <td>
                            <?php if($order['status']==1): ?><span style="color: orange;">待付款</span><?php endif; if($order['status']==2): ?><span style="color: orange;">待发货</span><?php endif; if($order['status']==3): ?><span style="color: #b2dba1;">待收货</span><?php endif; if($order['status']==4): ?><span style="color: green;">已收货</span><?php endif; if($order['status']==5): ?><span style="color: orangered;">已取消</span><?php endif; ?>
                        </td>
                        <td>
                            <div class="layui-btn-group">
                                <a <?php if($order['status']==2): ?> onclick="update(<?php echo $order['id']; ?>)" <?php endif; ?> title="发货" class="layui-btn layui-btn-normal layui-btn-sm">
                                    发货
                                </a>
                                <a title="取消订单" class="layui-btn layui-btn-danger layui-btn-sm" onclick="del(<?php echo $order['id']; ?>)">
                                    取消订单
                                </a>
                            </div>
                        </td>
