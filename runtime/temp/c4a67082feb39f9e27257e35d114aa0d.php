<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/www/wwwroot/shop.vohome.xin/public/../application/admin/view/category/edit.php";i:1512066812;s:70:"/www/wwwroot/shop.vohome.xin/public/../application/admin/view/base.php";i:1512722593;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
        ...
        <form onsubmit="post(event)" class="layui-form layui-form-pane"  id="submitform">
            <div class="layui-form-item pane">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" placeholder="请输入标题" autocomplete="off" class="layui-input"  value="<?php echo $oldData['name']; ?>">
                </div>
            </div>
                ...
                <div class="layui-input-block">
                    <select name="pid">
                        ...
                        <?php if (is_array($categorydata)): foreach ($categorydata as $column): ?>
                                <option value="<?php echo $column['id']; ?>" <?php echo $column['_disabled']; if ($column['id']==$oldData['pid']): ?>selected<?php endif;?>><?php echo $column['_name']; ?></option>
