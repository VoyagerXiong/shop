<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/www/wwwroot/shop.vohome.xin/public/../application/index/view/cartsave/index.php";i:1512700467;s:70:"/www/wwwroot/shop.vohome.xin/public/../application/index/view/base.php";i:1512978954;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="wrapper">
    <table class="cart-table">
        ...
        <tr class="goods">
            ...
            <td>￥<span class="unitprice"><?php echo $v['price']; ?></span></td>
            <td>
                <div class="mod-numbox cart-numbox" data-max="">
                    <span class="count-minus"></span>
                    <input class="count-input" value="<?php echo $v['num']; ?>"  type="text" name="num[]" sid="<?php echo $k; ?>"/>
                    <span class="count-plus"></span>
                </div>
            </td>
            <td class="txt-error">￥<span class="price"><?php echo $v['total']; ?></span></td>
            <td><a href="javascript:;" class="del iconfont icon-shanchu" sid="<?php echo $k; ?>"></a></td>
        </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
    <div class="cart-total-box">
        <div class="cart-total">
            ...
            <div class="fr">
                <div class="price">
                    合计（不含运费）：<span id="totalMoney"><?php echo ''; ?></span>元
                </div>
