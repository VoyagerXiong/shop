<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/shop.vohome.xin/public/../application/admin/view/order/create.php";i:1512066800;s:70:"/www/wwwroot/shop.vohome.xin/public/../application/admin/view/base.php";i:1512702900;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                <ul class="nav navbar-nav">
                    ...
                    <li class="top_menu ">
                        <a href="http://install.vohome.xin/index.php?s=wechat/wechatConfig/setting" class="quickMenuLink">
                            <i class="layui-icon" style="font-size: 24px;">&#xe63a;</i> 微信管理 </a>
                    </li>

                    <li class="top_menu ">
                        <a href="http://install.vohome.xin/index.php?s=system/backup/lists" class="quickMenuLink">
                            <i class="layui-icon" style="font-size: 24px;">&#xe631;</i> 系统管理 </a>
                    </li>

                    <li class="top_menu ">
                        <a href="http://install.vohome.xin/index.php?s=module/module/lists" class="quickMenuLink">
                            <i class="layui-icon" style="font-size: 24px;">&#xe61f;</i> 扩展模块 </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">
                            ...
                            <?php echo \think\Session::get('user.username'); ?><span class="caret"></span>
                        </a>
        ...
        <div class="col-xs-12 col-sm-3 col-lg-2 left-menu">
            ...
            <div class="panel panel-default">
                ...
                <ul class="list-group menus">
                    ...
                    <li class="list-group-item">
                        <a href="/order/create" class="quickMenuLink">订单编辑 </a>
                    </li>
                </ul>
                <div class="panel-heading">
